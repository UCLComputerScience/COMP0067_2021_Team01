...
web.get('/lecturer_module', function(req, res){
    ...
    connection.query(querySelectCurrentModule, function (error, currentModule) {
        ...
        connection.query(queryAllStudentTable, function (error, allStuInfo) {
            ...
            connection.query(queryAllStudentTableNoScore, function (error, allStuInfoNoScore) {
                if (error) {
                    console.log(error)
                }
                ...
                connection.query(queryAllGroupTable, function (error, allGroupInfo) {
                    ...
                    connection.query(queryAllGroupTableNoScore, function (error, allGroupInfoNoScore) {
                        if (error) {
                            console.log(error)
                        }
                        ...
                        connection.query(queryAttStudentTable, function (error, attStuInfo) {
                            ...
                            if (typeof attStuInfo !== 'undefined') {
                                for (var i = 0; i < attStuInfo.length; i++) {
                                    ...
                                    connection.query(queryInsertAttStudent, function (error, result) {
                                        if (error) {
                                            console.log(error)
                                        }
                                    })
                            ...
                            connection.query(queryAttStudentTableFalse, function (error, attStuInfoFalse) {
                                if (error) {
                                    console.log(error)
                                }
                                ...
                                connection.query(queryAttGroupTable, function (error, attGroupInfo) {
                                    ...
                                    if (typeof attGroupInfo !== 'undefined') {
                                        for (i = 0; i < attGroupInfo.length; i++) {
                                            ...
                                            connection.query(queryInsertAttGroup, function (error, result) {
                                                if (error) {
                                                    console.log(error)
                                                }
                                            })
                                    ...
                                    connection.query(queryAttGroupTableFalse, function (error, attGroupInfoFalse) {
                                        if (error) {
                                            console.log(error)
                                        }
...
web.get('/lecturer_delete_att_stu', function(req, res) {
    if (req.session.uname) {
        var uname = req.session.uname
        var allModules = req.session.allModules
        var selectedYT = req.session.ys
    ...
    connection.query(querySetAttStudentTrue, function (error, result) {
        if (error) {
            console.log(error)
        }
    })
...
web.get('/lecturer_delete_att_group', function(req, res) {
    if (req.session.uname) {
        var uname = req.session.uname
        var allModules = req.session.allModules
        var selectedYT = req.session.ys
    ...
    connection.query(querySetAttGroupTrue, function (error, result) {
        if (error) {
            console.log(error)
        }
    })
...
web.get('/lecturer_student', function(req, res){
    ...
    connection.query(querySelectCurrentModule, function (error, currentModule) {
        ...
        connection.query(querySelectStudent, function (error, student) {
            ...
            // }
            if (student.length === 0) {
                connection.query(queryStudentTeamProjectNoScore, function (error, student) {
                    if (error) {
                        console.log(error)
                    }
            ...
            fs.rename(uploadedPathTA, csv_dstPath_ta, function(err) {
                ...
                if(taHeader[0] === "taEmailAccount") {
                    for (var i = 1; i <= length; i++) {
                        ...
                        connection.query(queryInsertTAStuTe, function (error, results) {
                            if (error) {
                                console.log(error)
                            }
                        })
            ...
            fs.rename(uploadedPathStudent, csv_dstPath_student, function(err) {
                ...
                if(studentHeader[0] === "studentEmailAccount") {
                    for (var i = 1; i <= length; i++) {
                        ...
                        connection.query(queryInsertStudentStuTe, function (error, results) {
                            if (error) {
                                console.log(error)
                            }
                        })
...
web.get('/lecturer_delete_module', function(req, res){
    if (req.session.uname) {
        var uname = req.session.uname
        var selectedYT = req.session.ys
    } else {
    ...
    var queryDeleteModule = 'DELETE FROM `Module` WHERE `moduleCode`="' + module + '" AND `yearTerm`="' + selectedYT + '"'
     connection.query(queryDeleteModule, function (error, results) {
        if (error) {
            console.log(error)
        }
    })
    ...
    connection.query(queryDeleteStudentFeedback, function (error, results) {
        if (error) {
            console.log(error)
        }
    })
    ...
    connection.query(queryDeleteTeamFeedback, function (error, results) {
        if (error) {
            console.log(error)
        }
    })
...
web.get('/lecturer_download_csv', function(req, res) {
    if (req.session.uname) {
        var uname = req.session.uname
        var selectedYT = req.session.ys
    } else {
...
web.get('/lecturer_admin', function(req, res){
    ...
    connection.connect()
    connection.query(querySelect, function (error, allModules) {
        if (error) {
            console.log(error)
        }
...
web.get('/TA_module', function (req, res) {
    ...
    connection.query(querySelectCurrentMod, function (error, ModCurrent) {
        ...
        connection.query(queryCoachedGroupsNoScore, function (error, TAGroupsNoScore) {
            if (error) {
                console.log(error)
            }
            ...
            connection.query(queryTeamFeedback, function(error,TeamFeedback){
                ...
                connection.query(queryStudentFeedback, function(error,Student){
                    ...
                    connection.query(queryWeekNumber, function(error, weekNumbers) {
                        ...
                        // console.log(weeknum)
                        connection.query(queryGroup, function (error, TAGroup) {
                            if (error) {
                                console.log(error)
                            }
                            // console.log(TAGroup)
