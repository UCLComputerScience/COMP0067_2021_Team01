...
INSERT INTO `StudentFeedback` (`studentSPR`, `moduleCode`, `weekNumber`, `score`, `contribution`, `writtenFeedback`, `messageLecturer`) VALUES
('sss', 'COMP0067', '1', 4, '0.33', 'I really appreciated how you kept me up to date on X project this week — it helped me coordinate with our stakeholders, and I’m excited to share that we’re on track to launch. It’s also great to see your process. I’m impressed with the efficiencies you’re introducing.', ''),
('sss', 'COMP0067', '2', 4, '0.33', 'I’m curious about where we are with Y project. If any issues have come up, it’s best that I know as soon as possible so I can help you get back on target. How about you shoot me daily updates just so I know where we are?', ''),
('sss', 'COMP0067', '3', 4, '0.33', 'I can’t help but notice that this is the third deadline that’s caught up to you this month. I understand this is a fast-paced environment, and I think you’d be more effective if we rethought your time management strategies.', ''),
('sss', 'COMP0067', '4', 4, '0.33', 'Thanks for letting me know you’re running behind schedule on this project. Let’s take a look at your goals and see how you’re spending your time — I bet there are opportunities for efficiencies there.', ''),
...
('sss', 'COMP0067', '7', 4, '0.33', 'You know I’ve always appreciated your grasp of our larger vision, and it’s great that you see big-picture. But you’ve missed out on some smaller details in your last few projects, like X and Y. Unfortunately, that ultimately set the team back because they had to correct those oversights.', ''),
('sss', 'COMP0067', '8', 4, '0.33', 'I’d love for you to keep that big-picture vision while working on those little blind spots. For your next project, let’s put together a detailed checklist of all your deliverables to make sure you don’t miss anything. Give it a shot, then let’s follow up and reassess from there.', ''),
...
('sss', 'COMP0067', '10', 4, '0.33', 'It’d be great to see you tap into your resourcefulness and apply it to problem-solving before reaching out to others. Try sitting with an issue for 5 minutes before you reach out to anybody else.  If this doesn’t work, check in with me and we can come up with a solution.', ''),
...
('sss', 'COMP00142', '2', 4, '0.33', 'I’m glad we’re taking the time to check-in. I feel like you haven’t been as happy at work lately. How do you feel? Is there something I can do to help you have a better experience here?', ''),
('sss', 'COMP00142', '3', 4, '0.33', 'I know there are a lot of rumors flying around about X, and I know you’re concerned about it. I value your trust and contributions here, so I’d like to set the record straight and explain what I can.', ''),
('sss', 'COMP00142', '4', 4, '0.33', 'I understand your feelings, and I know it’s frustrating when you feel your questions aren’t being answered. In the future, though, please bring your concerns directly to me. When you share them with your teammates, it creates a company culture of fear and negativity without providing answers.', ''),
('sss', 'COMP00142', '5', 1, '0.33', 'This morning you left our team meeting early. I could tell you were frustrated by the discussion, but walking out on your teammates doesn’t show them the same respect they show you during the conflict. How can we find a solution moving forward?', ''),
('sss', 'COMP00142', '6', 5, '0.33', ' I wanted to check-in and see how you felt about your work this week. Samika mentioned that you used a sarcastic tone with her in a meeting and it made her uncomfortable. We need to be able to function as a team, and I was hoping to hear your side of the story to see if everything is okay.', '');
